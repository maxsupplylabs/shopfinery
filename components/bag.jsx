...
const BagItem = ({ item, onDelete, toggleCartItemQuantity }) => (
  <div className="flex p-2 my-2 gap-4 bg-gray-100 mx-2 rounded-md">
    {item.images &&
        ...
        <div className="">
          <Dialog>
            <DialogTrigger asChild>
              <div className="flex gap-1 bg-white border cursor-pointer border-gray-300 text-sm py-1 px-4 rounded-lg">
            ...
            <DialogContent className="sm:max-w-[567px] w-[95vw] rounded-md">
              <div className="flex flex-col text-center items-center justify-center mt-4">
                ...
                <h2 className="text-lg">Are you sure you want to remove this item from your cart?</h2>
              </div>
      ...
      <div>
        {bagItems.length === 0 ? (
          ...
          <div>
            ...
            <div className="flex flex-col relative top-3 mb-48">
              {bagItems.map((item) => (
                <BagItem
                  key={item.id}
                  item={item}
